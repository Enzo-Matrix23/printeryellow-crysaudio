...
; Viridian Gym
	...
	tr_mon 42, DUGTRIO
		tr_moves GROWL, DOUBLE_TEAM, SAND_ATTACK, SLASH
	tr_mon 44, NIDOQUEEN
		tr_moves EARTHQUAKE, TAIL_WHIP, THUNDER, DOUBLE_KICK
	tr_mon 45, NIDOKING
		tr_moves EARTHQUAKE, LEER, THUNDER, DOUBLE_KICK
	tr_mon 50, RHYDON
		tr_moves ROCK_SLIDE, TAIL_WHIP, FURY_ATTACK, EARTHQUAKE
	end_trainer
...
BrunoData:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 53, MACHOKE
		tr_moves FISSURE, KARATE_CHOP, DIG, SWIFT
	...
	tr_mon 56, MACHOKE
		tr_moves FISSURE, KARATE_CHOP, STRENGTH, COUNTER
	tr_mon 58, MACHAMP
		tr_moves FISSURE, KARATE_CHOP, HYPER_BEAM, SUBMISSION
	end_trainer
...
LtSurgeData:
	...
	tr_mon 18, PIKACHU
		tr_moves TAIL_WHIP, THUNDER_WAVE, QUICK_ATTACK, DOUBLE_TEAM
	tr_mon 24, RAICHU
		tr_moves THUNDERSHOCK, GROWL, THUNDER_WAVE
	end_trainer
...
ErikaData:
	...
	tr_mon 29, VICTREEBEL
		tr_moves RAZOR_LEAF, WRAP, MEGA_DRAIN, SLEEP_POWDER
	tr_mon 24, TANGELA
		tr_moves RAZOR_LEAF, BIND
	tr_mon 29, VILEPLUME
		tr_moves PETAL_DANCE, POISONPOWDER, STUN_SPORE, SLEEP_POWDER
	end_trainer
...
KogaData:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 37, KOFFING
		tr_moves TOXIC, TACKLE, SLUDGE, SMOKESCREEN
	tr_mon 39, MUK
		tr_moves TOXIC, POISON_GAS, SUPERSONIC, SLUDGE
	tr_mon 37, KOFFING
		tr_moves TOXIC, DOUBLE_EDGE, SLUDGE, SMOKESCREEN
	tr_mon 43, WEEZING
...
BlaineData:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 42, GROWLITHE
		tr_moves FLAMETHROWER, LEER, TAKE_DOWN, CONFUSE_RAY
	tr_mon 40, PONYTA
		tr_moves TAIL_WHIP, STOMP, GROWL, FIRE_SPIN
	tr_mon 42, RAPIDASH
		tr_moves FLAMETHROWER, FIRE_BLAST, REFLECT, FIRE_SPIN
	tr_mon 47, ARCANINE
...
SabrinaData:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 38, KADABRA
		tr_moves FLASH, PSYBEAM, RECOVER, PSYCHIC_M
	tr_mon 37, MR_MIME
		tr_moves KINESIS, BARRIER, LIGHT_SCREEN, PSYWAVE
	tr_mon 38, VENOMOTH
		tr_moves PSYWAVE, LEECH_LIFE, STUN_SPORE, PSYBEAM
	tr_mon 43, ALAKAZAM
...
Rival3Data:
	...
	def_trainer 1, TRAINERTYPE_MULTI_LEVELS
	tr_mon 61, PIDGEOT
		tr_moves WHIRLWIND, WING_ATTACK, EARTHQUAKE, MIRROR_MOVE
	tr_mon 59, ALAKAZAM
		tr_moves PSYBEAM, RECOVER, PSYCHIC_M, KINESIS
	tr_mon 61, RHYDON
		tr_moves TAIL_WHIP, FURY_ATTACK, HORN_DRILL, LEECH_SEED
	tr_mon 61, ARCANINE
		tr_moves ICE_BEAM, EMBER, LEER, TAKE_DOWN
	tr_mon 63, EXEGGUTOR
		tr_moves CONFUSE_RAY, HYPNOSIS, STOMP, FIRE_SPIN
	tr_mon 65, BLASTOISE
		tr_moves BITE, WITHDRAW, QUICK_ATTACK, HYDRO_PUMP
	end_trainer
	...
	tr_mon 61, RHYDON
		tr_moves TAIL_WHIP, FURY_ATTACK, HORN_DRILL, LEECH_SEED
	tr_mon 61, GYARADOS
		tr_moves THUNDERBOLT, LEER, HYDRO_PUMP, HYPER_BEAM
	tr_mon 63, ARCANINE
		tr_moves ICE_BEAM, EMBER, LEER, TAKE_DOWN
	tr_mon 65, VENUSAUR
		tr_moves RAZOR_LEAF, REFLECT, QUICK_ATTACK, SOLARBEAM
	end_trainer
	...
	tr_mon 63, GYARADOS
		tr_moves THUNDERBOLT, LEER, HYDRO_PUMP, HYPER_BEAM
	tr_mon 65, CHARIZARD
		tr_moves AURORA_BEAM, SLASH, QUICK_ATTACK, FIRE_SPIN
	end_trainer
